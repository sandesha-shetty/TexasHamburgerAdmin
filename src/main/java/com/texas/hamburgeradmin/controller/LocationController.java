...
//
//			if (name == null)
//				locationService.findAll().forEach(location::add);
//			else
//				locationService.findByNameContaining(name).forEach(location::add);
//
//			if (location.isEmpty()) {
...
//		Optional<Location> locationData = locationService.findById(id);
//
...
//			return new ResponseEntity<>(locationService.saveLocation(_location), HttpStatus.OK);
//		} else {
//			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
//		}
//	}
...
//		try {
//			List<Location> location = new ArrayList<>();
//			locationService.findByStatus(status).forEach(location::add);
//			return new ResponseEntity<>(location, HttpStatus.OK);
//		} catch (Exception e) {
//			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
//		}
